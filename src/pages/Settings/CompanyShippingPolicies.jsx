            ...
            <div key={index} className="p-4 border-2 border-gray-200 mb-4 text-gray-800">
              <div className="flex flex-col">
                ...
                <div className="flex gap-4">
                  <button className="font-semibold text-white bg-green-700 px-4 py-2">Edit</button>
                  <button className="font-semibold text-white bg-red-500 px-4 py-2">Remove</button>
                </div>
                </div>
