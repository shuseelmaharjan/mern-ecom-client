...
const EditAddress = ({
  ...
  const fetchAddressDetails = useCallback(async () => {
    try {
      const response = await shippingService.getIndividualShippingDetails(
        accessToken,
        address._id
      );
  ...
  }, [address._id, countries, fetchAddressDetails]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (address._id) {
        ...
        setAddSuccessMsg("Address updated successfully!");
      } else {
        await shippingService.addShippingDetails(accessToken, formData);
        setAddSuccessMsg("Address added successfully!");
      }
      fetchShippingDetails();
      openAddressTable();
    } catch (error) {
      console.error("Error saving details", error);
      setAddErrorMsg(error.message || "Error saving address.");
    }
  };
