...
const DefaultShippingAddress = ({ addresses, fetchShippingDetails, openAddressTable }) => {
  ...
  const handleUpdateConfirm = async() => {
    try{
        await shippingService.updateDefaultShippingAddress(accessToken, selectedAddressId);
