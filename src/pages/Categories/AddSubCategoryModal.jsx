...
const AddSubCategoryModal = ({ setAddSubCategory, selectedSubCategoryId, accessToken, selectedCategoryName, getData}) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await categoryService.createSubCategory(accessToken, selectedSubCategoryId, formData);
  ...
  return (
    <div className="absolute inset-0 flex justify-center items-center bg-black bg-opacity-50 z-50">
      <div className="bg-white rounded-lg shadow-lg w-full sm:w-8/12 md:w-6/12 lg:w-4/12 p-6">
        <h2 className="text-xl font-semibold mb-4 text-center">Add Child Category for {selectedCategoryName}</h2>
